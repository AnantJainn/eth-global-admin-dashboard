...
function ServiceForm({ addService }) {
  ...
  const styles = {
    ...
    blockchainPattern: {
      ...
      width: '100%',
      height: '100%',
      background: 'radial-gradient(circle, rgba(0,255,234,0.05) 1px, transparent 1px)',
    ...
    submitBtn: (isDisabled, isHovered) => ({
      backgroundColor: isDisabled ? '#555555' : (isHovered ? '#00d1b8' : '#00c9a7'),
      border: 'none',
      padding: '12px 25px',
      fontWeight: '700',
      fontSize: '16px',
  ...
  return (
    <div
      ...
      onMouseEnter={() => setHoveredSection('container')}
      onMouseLeave={() => setHoveredSection(null)}
    >
      <div style={styles.blockchainPattern}></div>

      <form style={styles.form} onSubmit={handleSubmit}>
        <div style={styles.formHeader}>
          <div style={styles.blockchainIcon}>⚡</div>
          <h2 style={styles.h2}>Add New Solar Project</h2>
          <p style={styles.p}>Deploy your renewable energy asset to the blockchain</p>
        </div>

        <div style={styles.formGrid}>
          {/* Image Upload Section */}
          <div
            style={{ ...styles.formSection(hoveredSection === 'media'), ...styles.fullWidth }}
            onMouseEnter={() => setHoveredSection('media')}
            onMouseLeave={() => setHoveredSection(null)}
          >
            <h3 style={styles.h3}>📸 Project Media</h3>
            <div style={styles.imageUploadContainer}>
              <label
                style={styles.imageUploadLabel(hoveredSection === 'upload')}
                ...
                <div>
                  {imagePreview ? (
                    ...
                    <div style={styles.uploadPlaceholder}>
                      ...
                      <span style={styles.uploadText}>Click to upload project image</span>
                    </div>
                  )}
                </div>
              </label>
            ...
            <div style={styles.checkboxGroup}>
              <label style={styles.checkboxLabel}>
                ...
                <span style={styles.checkmark(formData.isAvailable)}>
                  <span style={styles.checkmarkAfter(formData.isAvailable)}></span>
                </span>
          ...
          {/* Descriptions */}
          <div
            style={{ ...styles.formSection(hoveredSection === 'details'), ...styles.fullWidth }}
        ...
        <div style={styles.formActions}>
          <button
            ...
            style={styles.submitBtn(isSubmitting, hoveredSection === 'submit')}
            onMouseEnter={() => setHoveredSection('submit')}
            onMouseLeave={() => setHoveredSection(null)}
          >
            {isSubmitting ? (
              <>
